...
class NeededVisitsScreen extends StatelessWidget {
  const NeededVisitsScreen({super.key});
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text('filter_search'.tr , style: TextStyles.regular16().copyWith(color: const Color(0xff939393),),),
                    const Icon(Icons.keyboard_arrow_down , color: Color(0xff939393),)
                  ],
              )
                  ...
                  itemBuilder: (context, index) => Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Gaps.vGap20,
                        const CustomItemRow(title: 'زيارة قيد الانتظار - فى انتظار انهاء المهام', image: Assets.iconWaitingSvg)
                      ],
                    ),
                  ),
