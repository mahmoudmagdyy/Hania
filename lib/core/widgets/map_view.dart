...
import '../google_search/data/models/prediction_model.dart';
import '../google_search/presentation/views/awesome_search.dart';
        ...
        actions: [
          IconButton(
            onPressed: () {
              AwesomePlaceSearch(
                context: context,
                key: 'AIzaSyDEF6Aa40owGZ0K8C1_35sr6MEZdZ19udw',
                hint: 'search'.tr,
                onTap: (value) async {
                  PredictionModel position = await value;
